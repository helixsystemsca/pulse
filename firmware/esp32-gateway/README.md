# ESP32 gateway — security reference implementation

This folder documents **recommended patterns** for the BLE → ESP32 → cloud path. Production firmware should live in its own repo or submodule; this README is the contract IT and firmware teams can share.
