      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-3 md:gap-12">
          {items.map(({ icon: Icon, title, description }) => (
            <div
              key={title}
              className="flex h-full flex-col rounded-2xl border border-helix-outline/15 bg-white p-6 shadow-md"
            >
              <div className="flex h-14 w-14 shrink-0 items-center justify-center self-start rounded-2xl bg-helix-bg text-helix-primary">
