      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-3 md:gap-12">
          {steps.map(({ Icon, title, body }, i) => (
            <div
              key={title}
              className="group flex h-full flex-col rounded-2xl border border-helix-outline/20 bg-helix-bg p-6 shadow-md transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-[#d5e4f5] text-helix-primary transition-colors group-hover:bg-helix-primary group-hover:text-white">
