...
const INPUT =
  "rounded-lg border border-zinc-600 bg-zinc-900 px-3 py-2 text-sm text-white placeholder:text-zinc-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500";
const BTN_SECONDARY =
...
const BTN_GHOST = "rounded-lg px-3 py-2 text-sm font-medium text-zinc-400 hover:bg-zinc-800 hover:text-white";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-zinc-600 bg-zinc-900 px-4 py-2 text-sm font-semibold text-zinc-100 shadow-sm hover:bg-zinc-800"
          >
            Filters
            {activeCount > 0 ? (
      ...
      {filterOpen ? (
        ...
        >
          <div
            className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-2xl border border-zinc-700 bg-zinc-950 p-6 shadow-2xl"
            role="dialog"
            aria-modal="true"
          ...
          >
            <div className="flex items-start justify-between gap-4 border-b border-zinc-800 pb-4">
              <div>
                <h2 id="log-filter-title" className="text-lg font-semibold text-white">
                  Filter logs
                </h2>
                <p className="mt-1 text-sm text-zinc-500">Narrow by action, actor, target, or time range.</p>
              </div>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-end gap-2 border-t border-zinc-800 pt-5">
