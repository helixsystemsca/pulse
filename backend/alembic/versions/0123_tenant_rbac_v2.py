...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=False), nullable=False),
        sa.Column("company_id", UUID(as_uuid=False), nullable=False),
        sa.Column("department_id", UUID(as_uuid=False), nullable=False),
    ...
    op.create_table(
        "tenant_role_grants",
        sa.Column("tenant_role_id", UUID(as_uuid=False), nullable=False),
    ...
    op.add_column(
        "users",
        sa.Column("tenant_role_id", UUID(as_uuid=False), nullable=True),
    )
