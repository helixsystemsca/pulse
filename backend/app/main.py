...
from app.api.advertising_routes import router as advertising_router
...
from app.api.operational_improvements_routes import router as operational_improvements_router
...
from app.api.qr_routes import public_router as qr_public_router
...
from app.api.operational_xp_routes import router as operational_xp_router
...
if not _cors_origins and not settings.cors_origin_regex_pattern:
    _cors_log.warning(
        ...
        "Include every site Origin (e.g. https://panorama.helixsystems.ca, https://www.helixsystems.ca): CORS_ORIGINS "
...
app.include_router(qr_public_router, prefix="/api/public")
...
app.include_router(operational_improvements_router, prefix="/api/v1")
