...
export const MASTER_FEATURES: readonly MasterFeatureDef[] = [
  ...
  },
  {
    ...
    feature: "dashboard_kiosk",
    rbacAnyOf: [...dashboardRbacAnyOf("dashboard.kiosk.view")],
    navVisible: true,
    sortOrder: 15,
    navDomain: "Dashboards",
  ...
  },
  {
    ...
    rbacAnyOf: ["standards.training.view", "procedures.view"],
    navVisible: true,
    sortOrder: 302,
    navDomain: "Standards",
    navGroup: "Training",
  ...
  },
  {
    ...
    icon: "scroll-text",
    route: "/standards/certifications",
    feature: "standards_certifications",
    rbacAnyOf: ["standards.certifications.view", "procedures.view"],
    navVisible: true,
    sortOrder: 303,
    navDomain: "Standards",
    navGroup: "Certifications",
    navOrder: 10,
  },
  {
