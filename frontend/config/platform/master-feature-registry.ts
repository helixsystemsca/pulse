...
export const MASTER_FEATURES: readonly MasterFeatureDef[] = [
  ...
  },
  {
    ...
    /** Reach via Projects hub tabs — not a third dashboard peer in the rail. */
    navVisible: false,
    sortOrder: 12,
    navDomain: "Dashboards",
  ...
  },
  {
    ...
    /** In-page tab on the Projects hub — not a Planning flyout peer. */
    navVisible: false,
    sortOrder: 109,
    navDomain: "Planning",
    navGroup: "Projects",
...
/** Sidebar / flyout display label (override wins). */
export function masterFeatureNavLabel(feature: Pick<MasterFeatureDef, "label" | "navLabelOverride">): string {
  return feature.navLabelOverride?.trim() || feature.label;
}
