    ...
    extend: {
      ...
      colors: {
        ...
        ds: {
          ...
          "interactive-hover-strong": "var(--ds-interactive-hover-strong)",
          "interactive-active": "var(--ds-interactive-active)",
          "chrome-hover": "var(--ds-chrome-interactive-hover)",
          "chrome-active": "var(--ds-chrome-interactive-active)",
