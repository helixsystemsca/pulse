...
export default function OpsCopilotPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Ops Copilot"
        description="Starter questions for Vernon recreation operations. Answers cite Pulse records (assets, PMs, certifications, contractors, internal procedures) — not an LLM and not a regulatory citation."
        icon={MessageSquare}
      />
      <PageBody>
        {error ? (
        ...
        {answer ? (
          ...
          <p className="mt-6 text-sm text-ds-muted">Choose a starter question. Results stay in-app and update as you fill in records.</p>
        )}
      </PageBody>
    </div>
  );
