...
export const DASH = {
  ...
  /** Premium light glass panel + thin neutral border. */
  cardBase:
    "overflow-hidden rounded-[18px] border border-[rgba(120,140,160,0.14)] bg-white/70 shadow-[0_1px_0_rgba(255,255,255,0.9),0_12px_34px_rgba(15,23,42,0.06)] backdrop-blur-md dark:rounded-[var(--pulse-dashboard-card-radius)] dark:border-ds-border dark:bg-ds-primary dark:shadow-[var(--ds-shadow-card)]",
