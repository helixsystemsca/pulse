...
const FLYOUT_ITEM_DESCRIPTIONS: Partial<Record<string, string>> = {
  ...
  projects: "Operational projects, tasks, and workforce skill matching. Roadmap and PM tools are tabs on this hub.",
  ...
  ops_meetings: "Ops meeting notes and action items — not the Team Management meeting workspace.",
  ops_contacts: "Vendors, utilities, agencies, and after-hours callout numbers.",
  ...
  facilities_spatial: "Spatial drawings of buildings — facility master data lives under Facilities in Recreation.",
  live_map: "Real-time presence and activity across the facility.",
  workforce_hub: "Manager workspace — people, performance, growth, planning, and meetings as in-app sections.",
