...
export const MOCK_TRAINING_ASSIGNMENTS: TrainingAssignment[] = [
  ...
  assign({
    ...
    completed_date: null,
    expiry_date: null,
    acknowledgement_date: "2026-04-01T09:00:00",
    supervisor_signoff: false,
    verification_first_viewed_at: "2026-03-28T14:00:00Z",
    verification_last_viewed_at: "2026-04-01T08:00:00Z",
    quiz_passed_at: "2026-04-01T10:30:00Z",
  ...
  assign({
    ...
    supervisor_signoff: false,
    verification_first_viewed_at: "2026-05-12T11:00:00Z",
    verification_last_viewed_at: "2026-05-12T11:20:00Z",
    verification_total_view_seconds: 840,
  }),
  assign({
    employee_id: "emp-bw",
    ...
    completed_date: null,
    expiry_date: null,
    acknowledgement_date: "2026-05-01T16:00:00",
    supervisor_signoff: false,
    verification_first_viewed_at: "2026-04-28T10:00:00Z",
    quiz_attempt_count: 1,
    quiz_latest_score_percent: 67,
    quiz_latest_passed: false,
  }),
  assign({
    employee_id: "emp-bw",
...
export const MOCK_TRAINING_ACKNOWLEDGEMENTS: TrainingAcknowledgement[] = [
  {
    ...
    training_program_id: "tp-whmis",
    revision_number: 2,
    acknowledged_at: "2026-04-01T09:00:00",
  },
  {
    id: "ack-bw-alone",
    employee_id: "emp-bw",
    training_program_id: "tp-alone",
    revision_number: 1,
    acknowledged_at: "2026-05-01T16:00:00",
  },
  {
    id: "ack-nj-alone",
    employee_id: "emp-nj",
