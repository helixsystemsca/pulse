...
export const OPS_MODULES: readonly OpsModuleDef[] = [
  ...
  },
  {
    ...
    label: "Contractors",
    singular: "Contractor",
    description: "Contractor directory for trades, services, and preferred vendors.",
  ...
  },
  {
    ...
    label: "Regulations",
    singular: "Regulation",
    description: "Central reference for Technical Safety BC, WorkSafeBC, fire/building codes, and public health.",
    ...
    fields: [
      ...
      { key: "external_references", label: "External references", type: "json-list", placeholder: "URLs or citations, one per line" },
      SHARED_STATUS,
      SHARED_DESC,
      SHARED_TAGS,
      SHARED_NOTES,
