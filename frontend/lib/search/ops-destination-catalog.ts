...
export const OPS_ASK_CATALOG: readonly OpsAskCatalogItem[] = [
  ...
  },
  {
    ...
    phrases: ["equipment", "assets", "asset registry"],
...
export const OPS_COPILOT_PROMPT_MATCHERS: readonly {
  ...
  },
  {
    ...
    phrases: ["chief engineer responsibilities", "chief engineer", "chief engineer definition", "chief engineer duties", "power engineer in charge", "refrigeration operator", "ice facility operator"],
  },
  {
    id: "ohs-worksafebc",
    label: "OH&S / WorkSafeBC",
    phrases: ["ohs", "oh and s", "worksafebc", "occupational health", "chloramine", "chloramines", "chlorine exposure"],
  },
  {
    id: "building-code",
    label: "BC Building Code",
    phrases: ["building code", "bc building code", "bc codes", "assembly occupancy"],
  },
  {
