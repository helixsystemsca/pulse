...
export const RBAC_PERMISSION_CATALOG: readonly RbacPermissionMeta[] = [
  ...
  {
    key: "operational_improvements.view",
    label: "View operational improvements",
    description: "Open improvement opportunities, analysis, and knowledge base.",
    module: "operational_improvements",
    category: "Operations",
  },
  {
    key: "operational_improvements.manage",
    label: "Manage operational improvements",
    description: "Create and update improvement workflows, actions, and case studies.",
    module: "operational_improvements",
    category: "Operations",
  },
