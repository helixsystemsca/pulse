...
export function AuthBrandLink() {
  return (
    <Link
      ...
      className="flex items-center gap-2.5 font-panoramaBrand text-lg font-semibold uppercase tracking-[0.08em] text-ds-foreground no-underline transition-opacity hover:opacity-90 sm:text-xl"
    >
