...
export function AuthBrandLink() {
  return (
    <Link
      ...
      className="flex items-center gap-2.5 font-panoramaBrand text-lg uppercase text-ds-foreground no-underline transition-opacity hover:opacity-90 sm:text-xl"
    >
