...
export function SchedulePaletteManageModal({
  ...
  useEffect(() => {
    ...
    setShiftDraft({ id: "", code: "", name: "", start: "08:00", end: "16:00", shift_type: "day" });
  }, [open]);
  ...
  const editingShift = Boolean(shiftDraft.id);
      ...
      >
        <div className="flex items-center justify-between border-b border-pulseShell-border px-4 py-3">
          <div>
            ...
            <p className="mt-0.5 text-xs text-ds-muted">Company: {companyId.slice(0, 8)}…</p>
          </div>
          <button
            type="button"
        ...
        <div className="flex gap-1 border-b border-pulseShell-border px-4">
          {(["badges", "shifts"] as const).map((t) => (
            <button
              key={t}
              type="button"
              className={cn(
                "border-b-2 px-3 py-2 text-sm font-semibold capitalize",
                tab === t
            ...
            <div className="space-y-4">
              {!api ? (
                <p className="text-sm text-ds-muted">
                  Shift definitions are saved to the server in API mode. Connect the app to your tenant API to create and edit
                  shift codes here, or use the built-in demo catalog.
                </p>
              ) : (
                <>
                  <div className="rounded-lg border border-pulseShell-border/80 bg-ds-secondary/20 p-3">
                    ...
                    <div className="mt-2 grid grid-cols-2 gap-2 sm:grid-cols-3">
                      ...
                      <div className="col-span-2">
                        <label className="text-[10px] font-semibold uppercase text-ds-muted">Name</label>
                        <input
                          className={FIELD}
                      ...
                      <div>
                        <label className="text-[10px] font-semibold uppercase text-ds-muted">Start</label>
                        <input
                          className={FIELD}
                          type="time"
                      ...
                      <div>
                        <label className="text-[10px] font-semibold uppercase text-ds-muted">End</label>
                        <input
                          className={FIELD}
                          type="time"
                      ...
                      <div>
                        <label className="text-[10px] font-semibold uppercase text-ds-muted">Band</label>
                        <select
                          className={FIELD}
                    ...
                    <div className="mt-2 flex flex-wrap gap-2">
                      ...
                      >
                        {busy ? "Saving…" : editingShift ? "Save" : "Create"}
                      </button>
                      {editingShift ? (
                        <button
                          type="button"
                      ...
                      <a href="/schedule/shift-definitions" className="self-center text-xs font-semibold text-ds-accent underline">
                        Full shift-definitions page
                      </a>
                    </div>
                  </div>

                  <ul className="max-h-56 space-y-1 overflow-y-auto rounded-lg border border-pulseShell-border/80">
