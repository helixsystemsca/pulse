      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        {canMutate ? (
          <button
            type="button"
            onClick={openModal}
            className="inline-flex items-center gap-1.5 rounded-[10px] border border-slate-200/90 bg-white px-3 py-1.5 text-xs font-semibold text-pulse-navy shadow-sm hover:bg-ds-interactive-hover"
          >
          ...
          <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-xl border border-slate-200 bg-white p-5 shadow-xl">
            <div className="flex items-start justify-between gap-3">
              ...
              <button
                ...
                className="rounded-lg p-1.5 text-pulse-muted hover:bg-ds-interactive-hover-strong"
                aria-label="Close"
              >
                ...
                <ul className="mt-2 space-y-2">
                  {checklist.map((row) => (
                    <li key={row.id} className="flex gap-2">
                      ...
                      <button
                        type="button"
                        className="shrink-0 rounded-lg border border-slate-200 px-2 text-pulse-muted hover:bg-ds-interactive-hover"
            ...
            <div className="mt-6 flex flex-wrap justify-end gap-2">
              <button
                type="button"
                onClick={() => setModalOpen(false)}
                className="rounded-[10px] border border-slate-200 px-4 py-2 text-sm font-semibold text-pulse-navy hover:bg-ds-interactive-hover"
              >
                Cancel
              </button>
              <button
