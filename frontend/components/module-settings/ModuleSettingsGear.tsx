  ...
  return (
    <>
      <button
        ...
        className={`inline-flex items-center justify-center rounded-lg border border-slate-200/90 bg-white p-2.5 text-pulse-navy shadow-sm transition-colors hover:bg-ds-interactive-hover dark:border-ds-border dark:bg-ds-primary dark:text-slate-100 dark:hover:bg-ds-interactive-hover ${className}`.trim()}
        title={label}
        aria-label={label}
      >
