...
type ShiftBlock = {
  ...
  short: string;
  fullName: string;
  role: "Operations" | "Lead" | "Supervisor";
  roleTag?: "L" | "S";
  ticketed?: boolean;
  zone: string;
  time: string;
...
function demoThreeShiftBundle(): ShiftBlock[] {
  return [
    ...
    { code: "N", short: "Priya N.", fullName: "Priya Nair", role: "Operations", zone: "Pano", time: "22:00–06:00" },
    { code: "N", short: "Aisha T.", fullName: "Aisha Thomas", role: "Operations", zone: "Pano", time: "22:00–06:00" },
    {
      code: "N",
      short: "Diego F.",
